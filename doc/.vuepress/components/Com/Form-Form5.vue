<template>
    <div >
        <cmui-form label-width="100px" :model="form" :rules="rules">
        ...
        <div class="flex-container center">
            <button class="btn blue marginr20">注册</button>
            <button class="btn reverse">重置</button>
        </div>
    </div>
</template>
<script>
