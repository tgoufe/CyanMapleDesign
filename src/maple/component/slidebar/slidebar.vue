<template>
	<div class="cmui-slidebar" :class="{'start':value===0,'end':value===this.range}">
		<div class="cmui-slidebar__warp flex-container hfull">
			<div class="cmui-slidebar__bar pos-r"  ref="bar">
				<div class="cmui-slidebar__progress"
				:style="{width:transDisX+'px'}"
				></div>
				<div class="cmui-slidebar__dot"
				ref="dot"
