<template>
  <div class="marginb300">
    ...
    <div class="marginh30">
      <div class="flex-container bg-lightgray">
        <div class="paddingl30">
          <p class="text-black fw-20 fs-16">品质套餐</p>
          <p class="text-light fs-12">搭配齐全吃的好</p>
          <router-link to="/login">
            <p class="text-gloden fs-11">立即抢购 ></p>
          </router-link>
        </div>
          <img
            style="width:120px"
      ...
      <div class="flex-container padding30 margint30" style="background-color:#f3dda0;color:#644f1b;">
        <i class="iconfont icon-gifts"></i>
        <p class="marginl30">超级会员</p>
        <p class="fs-10 marginl30 left">每月领取20元红包</p>
        <p class="fs-11">立即开通</p>
      ...
      <cmui-affix :top="37">
        <div class="flex-container round paddingb30 text-light fs-14">
