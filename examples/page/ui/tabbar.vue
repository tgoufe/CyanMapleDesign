    ...
    <div class="padding10">
      ...
      >
        ...
        <cmui-collapse-item title="使用说明">
          <p class="marginb10">
            1.&lt;cmui-tabbar&gt;标签可包含多个slot="extra"的标签，如果&lt;cmui-tabbar&gt;的position属性为‘top'或'bottom'，拓展内容将出现在label标签的右侧，如果&lt;cmui-tabbar&gt;的position属性为‘left'或'right'，拓展内容将出现在label标签的底部。
          </p>
          <p class="marginb10">
            2.&lt;cmui-tabbar-item&gt;的内容将被当做每一个tabbar对应的内容并渲染。
          </p>
          <p class="marginb10">
            3.每个&lt;cmui-tabbar-item&gt;标签可包含一个slot="content"的节点，改节点的内容将作为对应标签的内容来实现。如果为&lt;cmui-tabbar-item&gt;设置了content属性，那么content属性对应的文本将作为tabbar的内容显示，并且优先级比slot高
          </p>
          <p class="marginb10">
            4.每个&lt;cmui-tabbar-item&gt;标签可包含一个slot="title"的节点，改节点的内容将作为对应标签的内容来实现。如果为&lt;cmui-tabbar-item&gt;设置了title属性，那么title属性对应的文本将作为tabbar的标签内容显示，并且优先级比slot高
          </p>
        </cmui-collapse-item>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td colspan="1">
                  <p>
                    this：tabbar组件的VM模型即cmui-tabbar
                    <br />item：被点击的拓展的VM模型即slot='extra'
                    <br />index：当前点击的拓展的索引
                  </p>
                </td>
                <td colspan="1">
              ...
              <tr>
                ...
                <td colspan="1">
                  <span>this：tabbar组件的VM模型即cmui-tabbar</span>
                  <br />
                  <span>item：被点击的标签的VM模型即cmui-tabbar-item</span>
                  <br />
                  <span>index：当前点击的标签的索引</span>
                  <br />
                  <span>oldIndex：点击前的活动索引</span>
                </td>
                <td colspan="1">
                  标签被点击
                </td>
